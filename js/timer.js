		...
		function keyPressed(e) {
		    	...
		    	if (e.keyCode == "32" && counting) {
		    		...
		    		//add time to database(ajax request to php/add_time.php)
		    		var httpRequest;
		    		...
		    		xmlhttp.open("GET","../src/php/add_time.php?time=" + time +"&scramble=" + currentScramble  ,true);
					xmlhttp.send();
					//print new scramble
					//TODO 
	...
	function puzzleSelect(){
		...
		var discipline = puzzleSelect.options[puzzleSelect.selectedIndex].value;
		xmlhttp.open("GET","../src/php/change_puzzle.php?current_discipline=" + discipline  ,true);
		xmlhttp.send();
    ...
    function createPractice(){
		    		...
		    		xmlhttp.open("GET","../src/php/create_practice.php"  ,true);
					xmlhttp.send();
